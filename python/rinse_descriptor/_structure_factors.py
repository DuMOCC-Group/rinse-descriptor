...
1. ``xrs.structure_factors(anomalous_flag=True)`` → unique reflections including
   both Friedel mates (F(hkl) and F(-h-k-l) treated as independent when anomalous
...
the descriptor can distinguish enantiomeric crystal structures if odd-l
spherical harmonics are included.
